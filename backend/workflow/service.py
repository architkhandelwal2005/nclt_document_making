...
EVENT_TYPES = {
    ...
    # EOI, PRA and resolution-plan process (CIRP-085--105).  These event
    # names represent recorded human-controlled milestones, not automated
    # eligibility, compliance, selection or legal conclusions.
    "EOI_PROCESS_DRAFTED", "EOI_PROCESS_APPROVED", "EOI_PUBLISHED",
    "EOI_RECEIVED", "EOI_DOCUMENT_DEFICIENCY_IDENTIFIED",
    "PRA_ELIGIBILITY_REVIEW_STARTED", "PRA_ELIGIBILITY_REVIEW_COMPLETED",
    "PROVISIONAL_PRA_LIST_APPROVED", "PROVISIONAL_PRA_LIST_ISSUED",
    "PRA_OBJECTION_RECEIVED", "PRA_OBJECTION_DECIDED",
    "FINAL_PRA_LIST_APPROVED", "FINAL_PRA_LIST_ISSUED",
    "RFRP_APPROVED", "EVALUATION_MATRIX_APPROVED",
    "PRA_ISSUE_PACKAGE_SENT", "PRA_VDR_ACCESS_GRANTED",
    "PRA_QUERY_RECEIVED", "PRA_QUERY_RESPONDED", "PROCESS_ADDENDUM_ISSUED",
    "RESOLUTION_PLAN_RECEIVED", "RESOLUTION_PLAN_REVISED",
    "SECTION_30_REVIEW_COMPLETED", "PRA_FINAL_ELIGIBILITY_REVIEW_COMPLETED",
    "PLAN_REVIEW_QUERY_RAISED", "PLAN_REVIEW_QUERY_RESPONDED",
    "PLAN_EVALUATION_COMPLETED", "NEGOTIATION_ROUND_OPENED", "NEGOTIATION_ROUND_CLOSED",
    "PLAN_PLACED_BEFORE_COC", "PLAN_VOTING_COMPLETED", "SUCCESSFUL_RA_SELECTED",
    "PERFORMANCE_SECURITY_RECEIVED", "PLAN_APPROVAL_APPLICATION_CREATED", "PLAN_APPROVAL_APPLICATION_FILED",
}
